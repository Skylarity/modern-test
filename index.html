...
<html lang="en">
	<head>
		...
		<title>A Modern Site</title>
	</head>
	<body>
		<div class="jumbotron mountain white">
			<div class="container">
				<h1>This is a modern looking site.</h1>

				<p>It has a nice tagline and stuff.</p>

				<p><a class="btn btn-success btn-lg" href="#" role="button">Great!</a></p>
			</div>
		</div>
	</body>
</html>
